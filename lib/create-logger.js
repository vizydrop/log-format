...
const createLogger = (opts = {}) => {
    ...
    const additionalFieldsContainer = createAdditionalFieldsContainer(initialAdditionalFields);
    const additionalFieldsFormatter = winston.format((info) => addAdditionalFields({
        info,
